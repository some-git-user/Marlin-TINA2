 ...
 * For wifi support you need a dedicated board under rear top of printer.
 */
#define TINA2_BASIC
...
// #define WIFISUPPORT
#warning "Wifi build currently not supported by community version"
#endif
...
#define STRING_CONFIG_H_AUTHOR "some-git-user" // Who made the changes.
